...
var checkState = function (client, input) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_g) {
        switch (_g.label) {
            case 0:
                _g.trys.push([0, 2, , 3]);
                return [4, client.send(new DescribeProjectVersionsCommand(input))];
            case 1:
                result_1 = _g.sent();
                reason = result_1;
                try {
                    returnComparator = function () {
                        var flat_1 = [].concat.apply([], __spreadArray([], __read(result_1.ProjectVersionDescriptions), false));
...
export var waitUntilProjectVersionTrainingCompleted = function (params, input) { return __awaiter(void 0, void 0, void 0, function () {
